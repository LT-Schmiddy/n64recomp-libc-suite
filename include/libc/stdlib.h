 ...
 * */
RECOMP_CORE_DECLARATION(int rc_atoi(const char* str));
 ...
 * 	the return value is undefined. If no conversion can be performed, ​0​ is returned.
 * */
RECOMP_CORE_DECLARATION(long rc_atol(const char* str));
 ...
 * 	the return value is undefined. If no conversion can be performed, ​0​ is returned.
 * */
RECOMP_CORE_DECLARATION(long long rc_atoll(const char* str));
 ...
 * */
RECOMP_CORE_DECLARATION(double rc_atof(const char* str));
 ...
 * */
RECOMP_CORE_DECLARATION(float strtof(const char* __restrict str, char** __restrict str_end));
 ...
 *  If no conversion can be performed, ​0​ is returned.
 * */
RECOMP_CORE_DECLARATION(long rc_strtol(const char* __restrict str, char** __restrict str_end, int base));
 ...
 *  If no conversion can be performed, ​0​ is returned.
 * */
RECOMP_CORE_DECLARATION(unsigned long rc_strtoul(const char* __restrict str, char** __restrict str_end, int base));
 ...
 *  If no conversion can be performed, ​0​ is returned.
 * */
RECOMP_CORE_DECLARATION(long long rc_strtoll(const char* __restrict str, char** __restrict str_end, int base));
 ...
 *  If no conversion can be performed, ​0​ is returned.
 * */
RECOMP_CORE_DECLARATION(unsigned long long rc_strtoull(const char* __restrict str, char** __restrict str_end, int base));
 ...
 * */
RECOMP_CORE_DECLARATION(int rc_abs(int n));
 ...
 * @return The absolute value of n (i.e. |n|), if it is representable.
 * */
RECOMP_CORE_DECLARATION(long rc_labs(long n));
 ...
 * @return The absolute value of n (i.e. |n|), if it is representable.
 * */
RECOMP_CORE_DECLARATION(long long rc_llabs(long long n));
 ...
 * */
RECOMP_CORE_DECLARATION(div_t rc_div(int x, int y));
 ...
 * If either the remainder or the quotient cannot be represented, the behavior is undefined.
 * */
RECOMP_CORE_DECLARATION(ldiv_t rc_ldiv(long x, long y));
 ...
 * If either the remainder or the quotient cannot be represented, the behavior is undefined.
 * */
RECOMP_CORE_DECLARATION(lldiv_t rc_lldiv(long long x, long long y));

#pragma mark - random number generation -

RECOMP_CORE_DECLARATION(int rand_r(unsigned int* ctx));
 ...
 * */
RECOMP_CORE_DECLARATION(int rc_rand(void));
 ...
 * */
RECOMP_CORE_DECLARATION(void rc_srand(unsigned seed));
 ...
 *
 * */
RECOMP_CORE_DECLARATION(int rc_heapsort(void* vbase, size_t nmemb, size_t size, int (*compar)(const void*, const void*)));
 ...
 *
 * */
RECOMP_CORE_DECLARATION(int rc_heapsort_r(void* vbase, size_t nmemb, size_t size, void* thunk,
 ...
 * */
RECOMP_CORE_DECLARATION(void* rc_bsearch(const void* key, const void* ptr, size_t count, size_t size,
 ...
 *  The function must not modify the objects passed to it and must return consistent
 * */
RECOMP_CORE_DECLARATION(void rc_qsort_r(void* a, size_t n, size_t es, void* thunk,
 ...
 *  The function must not modify the objects passed to it and must return consistent
 * */
RECOMP_CORE_DECLARATION(void rc_qsort(void* a, size_t n, size_t es, int (*compar)(const void*, const void*)));
 ...
 * */
RECOMP_CORE_DECLARATION(void* rc_malloc(size_t size));
 ...
 * */
RECOMP_CORE_DECLARATION(void rc_free(void* ptr));
 ...
 * @return (None)
 * */
RECOMP_CORE_DECLARATION(void* rc_calloc(size_t num, size_t size));
 ...
 * */
RECOMP_CORE_DECLARATION(void* rc_realloc(void* ptr, size_t size));
 ...
 *	If `size` is zero (e.g. `realloc(ptr,0)`) then returns NULL
 * */
RECOMP_CORE_DECLARATION(void* reallocf(void* ptr, size_t size));
